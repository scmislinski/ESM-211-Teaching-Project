...
#This is the monarch data Need to delete before the demo
...
THIS IS ONLY FOR THE MILKWEED DATA I was thinking that we could demonstrate it for one of the data sets and then have them do it for the other one.
...
```{r}
response_curve(fitted = fits, modelID = "ModelID_31", variable = "wc2.1_2.5m_bio_1")
response_curve(fitted = fits, modelID = "ModelID_31", variable = "wc2.1_2.5m_bio_12")
```
